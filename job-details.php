...
<html>
				...
				<!-- Menu -->
					<nav id="menu">
						...
						<ul>
							...
							<li><a href="jobs.php" class="active">Buyer</a></li>


									<li><a href="index1.php">Seller</a></li>
    ...
    while($row = mysqli_fetch_assoc($result)) { ?>
					<div id="main">
						<div class="inner">
							<h1><?php echo $row['job_title']; ?><span class="pull-right"><?php echo $row['job_salary']; ?> PKR</span></h1>
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-lg-5">
										...
										<a href="#" class="button primary">Apply for this job</a>
									</div>
								</div>
							</div>
							<?php } 
